...
-- CreateEnum
CREATE TYPE "CardStatus" AS ENUM ('GOOD', 'MEDIUM', 'BAD', 'NOTREAD');
...
CREATE TABLE "ProgressCard" (
    ...
    "category" "CardStatus" NOT NULL DEFAULT 'NOTREAD',
    "dateCreated" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,

    CONSTRAINT "ProgressCard_pkey" PRIMARY KEY ("progressId","cardId")
);
...
-- AddForeignKey
ALTER TABLE "Progress" ADD CONSTRAINT "Progress_collectionId_fkey" FOREIGN KEY ("collectionId") REFERENCES "Collection"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "ProgressCard" ADD CONSTRAINT "ProgressCard_cardId_fkey" FOREIGN KEY ("cardId") REFERENCES "Card"("id") ON DELETE CASCADE ON UPDATE CASCADE;
